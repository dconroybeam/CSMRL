...
c<-seq(.2,2,length.out=5)
cRecip<-seq(.2,2,length.out=5)
...
e<-seq(.01,.20,length.out=5)
eRecip<-seq(.01,.20,length.out=5)
...
for(s in 1:5){
  ...
  for(l in 1:loops){
    ...
    for(b in 1:blocks){
      ...
      #Invest in proportion to perceived MV
      investPropsMale<-t(apply(eRecipInvestMale,1,function(x)
        x*(10/sum(x))))
      
      investPropsFemale<-t(apply(eRecipInvestFemale,1,function(x)
        x*(10/sum(x))))
      ...
      #Invest in proportion to perceived MV
      investPropsMale<-t(apply(uRecipInvestMale,1,function(x)
        x*(10/sum(x))))
      
      investPropsFemale<-t(apply(uRecipInvestFemale,1,function(x)
        x*(10/sum(x))))
      ...
      #Invest in proportion to perceived MV
      investPropsMale<-t(apply(tRecipInvestMale,1,function(x)
        x*(10/sum(x))))
      
      investPropsFemale<-t(apply(tRecipInvestFemale,1,function(x)
        x*(10/sum(x))))
