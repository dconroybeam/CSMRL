...
for(s in 1:5){
  ...
  for(l in 1:loops){
    ...
    simResults<-data.frame("s"=s,"loop"=l,"model"=NA,
                           "obs"=NA,
                           "r"=NA,
                           "acc"=NA)
